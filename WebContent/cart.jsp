...
<%@ page import="com.tarena.shoppingcart.bean.*,com.tarena.shoppingcart.util.*,java.util.*"%>
<html>
	<head>
						...
						<table class="guide" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tbody>
								<tr>
									<td>
										<a href='#'>主页</a>&nbsp;/&nbsp;
										<a href='computer_list.html'>笔记本订购(WEB007)</a>
											&nbsp;/&nbsp;购物车信息
									</td>
								</tr>
							</tbody>
						...
						<table class="tableborder" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tbody>
								...
								<tr>
									...
									<td class="altbg2">
										<input type="text" size="3" value="<%=item.getQuantity()%>" 
											id="quantity_<%=item.getComputer().getId()%>"/>
									</td>
									<td class="altbg2">
										<a href="javascript:;" onclick="location='modify.do?id=<%=item.getComputer().getId()%>&quantity=' + document.getElementById('quantity_<%=item.getComputer().getId()%>').value;">更改数量</a>
									</td>
									<td class="altbg2">
										<a href="delete.do?id=<%=item.getComputer().getId()%>">
											删除
										</a>
									</td>
								</tr>
